...
```sh
  cd my-folder
  git clone https://github.com/Goruchie/TDD-project.git
```
### Install
...
Feel free to check the [issues page](https://github.com/Goruchie/TDD-project/issues.
...
- Special Thanks to everyone who will get time to check this code and suggest any [issue](https://github.com/Goruchie/TDD-project/issues)
